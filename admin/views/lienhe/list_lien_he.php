...
<head>
    ...
    <meta charset="utf-8" />
    <title>Quản lý liên hệ | NN Shop</title>
                            ...
                            <div class="h-100">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="?act=form-them-lien-he" class="btn btn-soft-success material-shadow-none">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($lienHes as $index => $lienHe) : ?>
                                                            <tr>
                                                                ...
                                                                <td><?= date("d-m-Y", strtotime($lienHe['ngay_tao'])) ?></td>
                                                                <td>
                                                                    <?php
