    ...
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
        <div class="card" style="width: 30rem;">
            <div class="card-body">
                ...
                <form action="<?= 'http://localhost/PH49685-DuAn1/base_du_an_1/index.php' . '?act=check-login' ?>" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <a href="<?= 'http://localhost/PH49685-DuAn1/base_du_an_1/index.php' . '?act=dangky' ?>" class="text-decoration-none">Chưa có tài khoản? Đăng ký ngay!</a>
                    </div>
